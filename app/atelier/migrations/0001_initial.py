    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('annimateur_possible', models.ManyToManyField(help_text='liste des personnes capable de faire le cour   ', to=settings.AUTH_USER_MODEL)),
                ('niveau', models.ForeignKey(help_text="Niveau de difficulté de l'atelier", on_delete=django.db.models.deletion.PROTECT, to='atelier.niveau')),
                ('publique', models.ForeignKey(help_text='type de publics pouvant être intéressé', on_delete=django.db.models.deletion.PROTECT, to='atelier.publique')),
